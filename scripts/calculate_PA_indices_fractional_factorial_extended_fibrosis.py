...
for cas in cases:
    ...
    for key, value in runs.items():
        ...
        if key == "Run1" and cas == "P1":
            A_index = 117
            P_index = 762
        elif key == "Run3" and cas == "P1":
            A_index = 116
            P_index = 761
        elif key == "Run4" and cas == "P1":
            A_index = 116
            P_index = 771
        elif key == "Run5" and cas == "P1":
            A_index = 116
            P_index = 785
        elif key == "Run6" and cas == "P1":
            A_index = 117
            P_index = 776
        elif key == "Run8" and cas == "P1":
            A_index = 117
            P_index = 768
        elif key == "Run9" and cas == "P1":
            A_index = 119
            P_index = 721
        elif key == "Run10" and cas == "P1":
            A_index = 119
            P_index = 718
        elif key == "Run11" and cas == "P1":
            A_index = 119
            P_index = 729
        elif key == "Run12" and cas == "P1":
            A_index = 119
            P_index = 719
        elif key == "Run13" and cas == "P1":
            A_index = 118
            P_index = 731
        elif key == "Run14" and cas == "P1":
            A_index = 117
            P_index = 738
        elif key == "Run15" and cas == "P1":
            A_index = 116
            P_index = 736
        elif key == "Run16" and cas == "P1":
            A_index = 118
            P_index = 733
        elif key == "Run17" and cas == "P1":
            A_index = 117
            P_index = 769
        elif key == "Run18" and cas == "P1":
            A_index = 115
            P_index = 759
        elif key == "Run21" and cas == "P1":
            A_index = 117
            P_index = 771
        elif key == "Run22" and cas == "P1":
            A_index = 118
            P_index = 777
        elif key == "Run23" and cas == "P1":
            A_index = 115
            P_index = 767
        elif key == "Run25" and cas == "P1":
            A_index = 119
            P_index = 716
        elif key == "Run26" and cas == "P1":
            A_index = 119
            P_index = 718
        elif key == "Run27" and cas == "P1":
            A_index = 119
            P_index = 718
        elif key == "Run28" and cas == "P1":
            A_index = 119
            P_index = 717
        elif key == "Run29" and cas == "P1":
            A_index = 117
            P_index = 735
        elif key == "Run30" and cas == "P1":
            A_index = 118
            P_index = 729
        elif key == "Run32" and cas == "P1":
            A_index = 117
            P_index = 734
        elif key == "Run1" and cas == "P2":
            A_index = 117
            P_index = 773
        elif key == "Run2" and cas == "P2":
            A_index = 119
            P_index = 793
        elif key == "Run7" and cas == "P2":
            A_index = 118
            P_index = 803
        elif key == "Run8" and cas == "P2":
            A_index = 116
            P_index = 783
        elif key == "Run14" and cas == "P2":
            A_index = 118
            P_index = 741
        elif key == "Run15" and cas == "P2":
            A_index = 117
            P_index = 739
        elif key == "Run18" and cas == "P2":
            A_index = 116
            P_index = 771
        elif key == "Run20" and cas == "P2":
            A_index = 118
            P_index = 774
        elif key == "Run29" and cas == "P2":
            A_index = 118
            P_index = 737
        elif False:
...
for cas, axs in zip(cases, axes):
    baseline = f"{mainfolder}/{cas}/baseline/cav.LA.csv"
